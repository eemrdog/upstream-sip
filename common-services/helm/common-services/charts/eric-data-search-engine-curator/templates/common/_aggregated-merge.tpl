...
{{- define "eric-data-search-engine-curator.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-search-engine-curator.mergeAnnotations" -}}
  {{- include "eric-data-search-engine-curator.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-search-engine-curator.mergeLabels" -}}
  {{- include "eric-data-search-engine-curator.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}