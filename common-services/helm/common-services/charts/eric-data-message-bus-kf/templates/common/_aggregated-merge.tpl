...
{{- define "eric-data-message-bus-kf.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-message-bus-kf.mergeAnnotations" -}}
  {{- include "eric-data-message-bus-kf.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-message-bus-kf.mergeLabels" -}}
  {{- include "eric-data-message-bus-kf.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}