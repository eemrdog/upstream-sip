...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-global" -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-internal" -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-name" -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-container" -}}
{{- $g := fromJson (include "eric-data-message-bus-kf.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-message-bus-kf.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-data-message-bus-kf.logshipper-image" . }}
  args:
  ...
  - name: SERVICE_ID
    value: {{ include "eric-data-message-bus-kf.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-data-message-bus-kf.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-data-message-bus-kf.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-volume" -}}
{{- $g := fromJson (include "eric-data-message-bus-kf.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-message-bus-kf.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-data-message-bus-kf.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-data-message-bus-kf.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-data-message-bus-kf.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-data-message-bus-kf.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-data-message-bus-kf.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-data-message-bus-kf.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-data-message-bus-kf.logshipper-annotations" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-data-message-bus-kf.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-data-message-bus-kf.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-data-message-bus-kf.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
