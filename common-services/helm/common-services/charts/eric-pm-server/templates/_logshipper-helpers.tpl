...
*/}}
{{- define "eric-pm-server.logshipper-global" -}}
...
*/}}
{{- define "eric-pm-server.logshipper-internal" -}}
...
*/}}
{{- define "eric-pm-server.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-pm-server.logshipper-name" -}}
...
app.kubernetes.io/name: {{ include "eric-pm-server.name" . | quote }}
...
*/}}
{{- define "eric-pm-server.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-pm-server.LsSeccompProfile" -}}
...
*/}}
{{- define "eric-pm-server.logshipper-container" -}}
{{- $g := fromJson (include "eric-pm-server.logshipper-global" .) }}
{{- $default := fromJson (include "eric-pm-server.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-pm-server.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-pm-server.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-pm-server.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-pm-server.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-pm-server.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-pm-server.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-pm-server.logshipper-volume" -}}
{{- $g := fromJson (include "eric-pm-server.logshipper-global" .) }}
{{- $default := fromJson (include "eric-pm-server.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-pm-server.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-pm-server.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-pm-server.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-pm-server.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-pm-server.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-pm-server.logshipper-labels" . | nindent 4 }}
  annotations:
    {{- include "eric-pm-server.logshipper-annotations" . | nindent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-pm-server.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-pm-server.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-pm-server.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
