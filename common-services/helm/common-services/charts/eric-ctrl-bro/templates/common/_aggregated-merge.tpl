...
{{- define "eric-ctrl-bro.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-ctrl-bro.mergeAnnotations" -}}
  {{- include "eric-ctrl-bro.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-ctrl-bro.mergeLabels" -}}
  {{- include "eric-ctrl-bro.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
