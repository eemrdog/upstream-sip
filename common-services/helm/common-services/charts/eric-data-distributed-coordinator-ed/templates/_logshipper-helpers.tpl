...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-global" -}}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-internal" -}}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-name" -}}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-container" -}}
{{- $g := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-data-distributed-coordinator-ed.logshipper-image" . }}
  args:
  ...
  - name: SERVICE_ID
    value: {{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-volume" -}}
{{- $g := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-data-distributed-coordinator-ed.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-data-distributed-coordinator-ed.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-data-distributed-coordinator-ed.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-data-distributed-coordinator-ed.productinfo" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-data-distributed-coordinator-ed.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-data-distributed-coordinator-ed.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
  ...
  {{- else -}}
    ...
    {{- $default := merge $default (dict "images" (dict "logshipper" (dict "tag" "9.0.0-25" ))) -}}
  {{- end -}}
