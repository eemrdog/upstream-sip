...
{{- define "eric-lm-combined-server.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-lm-combined-server.mergeAnnotations" -}}
  {{- include "eric-lm-combined-server.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-lm-combined-server.mergeLabels" -}}
  {{- include "eric-lm-combined-server.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}