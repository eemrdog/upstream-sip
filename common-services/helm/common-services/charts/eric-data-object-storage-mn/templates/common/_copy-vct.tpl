...
*/ -}}
{{- define "eric-data-object-storage-mn.copyVCTMetadataFields" -}}
...
*/ -}}
{{- define "eric-data-object-storage-mn.copyVCTAnnotations" -}}
  {{- include "eric-data-object-storage-mn.copyVCTMetadataFields" (dict "metadataField" "annotations" "vctName" .vctName "customKeys" .customKeys "release" .release "name" .name) | trim -}}
{{- end -}}

{{- define "eric-data-object-storage-mn.copyVCTLabels" -}}
  {{- $defaultLabels := dict "app.kubernetes.io/instance" .release.Name -}}
  {{- $mergedLabels := include "eric-data-object-storage-mn.mergeLabels" (dict "location" (printf "%s.copyVCT" .name) "sources" (list $defaultLabels .customKeys)) | fromYaml -}}
  {{- include "eric-data-object-storage-mn.copyVCTMetadataFields" (dict "metadataField" "labels" "vctName" .vctName "customKeys" $mergedLabels "release" .release "name" .name) | trim -}}
{{- end -}}
