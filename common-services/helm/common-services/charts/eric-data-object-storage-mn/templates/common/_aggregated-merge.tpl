...
{{- define "eric-data-object-storage-mn.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-object-storage-mn.mergeAnnotations" -}}
  {{- include "eric-data-object-storage-mn.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-object-storage-mn.mergeLabels" -}}
  {{- include "eric-data-object-storage-mn.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
