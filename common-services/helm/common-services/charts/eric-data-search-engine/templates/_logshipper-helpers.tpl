...
*/}}
{{- define "eric-data-search-engine.logshipper-global" -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-internal" -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-name" -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-data-search-engine.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-data-search-engine.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-data-search-engine.logshipper-container" -}}
{{- $g := fromJson (include "eric-data-search-engine.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-search-engine.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-data-search-engine.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-data-search-engine.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-data-search-engine.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-data-search-engine.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-data-search-engine.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-data-search-engine.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-volume" -}}
{{- $g := fromJson (include "eric-data-search-engine.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-search-engine.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-data-search-engine.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-data-search-engine.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-data-search-engine.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-data-search-engine.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-data-search-engine.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-data-search-engine.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-data-search-engine.logshipper-annotations" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-data-search-engine.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-data-search-engine.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-data-search-engine.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
