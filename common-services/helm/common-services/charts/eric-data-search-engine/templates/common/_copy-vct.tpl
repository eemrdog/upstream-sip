...
*/ -}}
{{- define "eric-data-search-engine.copyVCTMetadataFields" -}}
...
*/ -}}
{{- define "eric-data-search-engine.copyVCTAnnotations" -}}
  {{- include "eric-data-search-engine.copyVCTMetadataFields" (dict "metadataField" "annotations" "vctName" .vctName "customKeys" .customKeys "release" .release "name" .name) | trim -}}
{{- end -}}

{{- define "eric-data-search-engine.copyVCTLabels" -}}
  {{- $defaultLabels := dict "app.kubernetes.io/instance" .release.Name -}}
  {{- $mergedLabels := include "eric-data-search-engine.mergeLabels" (dict "location" (printf "%s.copyVCT" .Name) "sources" (list $defaultLabels .customKeys)) | fromYaml -}}
  {{- include "eric-data-search-engine.copyVCTMetadataFields" (dict "metadataField" "labels" "vctName" .vctName "customKeys" $mergedLabels "release" .release "name" .name) | trim -}}
{{- end -}}