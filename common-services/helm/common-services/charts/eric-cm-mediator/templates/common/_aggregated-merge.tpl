...
{{- define "eric-cm-mediator.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-cm-mediator.mergeAnnotations" -}}
  {{- include "eric-cm-mediator.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-cm-mediator.mergeLabels" -}}
  {{- include "eric-cm-mediator.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
