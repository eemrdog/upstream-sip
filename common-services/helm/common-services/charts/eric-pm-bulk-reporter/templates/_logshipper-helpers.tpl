...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-global" -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-internal" -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-name" -}}
...
app.kubernetes.io/name: {{ include "eric-pm-bulk-reporter.name" . | quote }}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-container" -}}
{{- $g := fromJson (include "eric-pm-bulk-reporter.logshipper-global" .) }}
...
- name: "logshipper"
  ...
  - name: SERVICE_ID
    value: {{ include "eric-pm-bulk-reporter.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-pm-bulk-reporter.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-pm-bulk-reporter.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-volume" -}}
{{- $g := fromJson (include "eric-pm-bulk-reporter.logshipper-global" .) }}
{{- $default := fromJson (include "eric-pm-bulk-reporter.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-pm-bulk-reporter.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-pm-bulk-reporter.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-pm-bulk-reporter.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-pm-bulk-reporter.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
spec:
  ...
  certificate:
    subject:
      cn: {{ include "eric-pm-bulk-reporter.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-pm-bulk-reporter.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
