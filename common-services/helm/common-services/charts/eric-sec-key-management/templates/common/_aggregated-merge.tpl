...
{{- define "eric-sec-key-management.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sec-key-management.mergeAnnotations" -}}
  {{- include "eric-sec-key-management.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sec-key-management.mergeLabels" -}}
  {{- include "eric-sec-key-management.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
