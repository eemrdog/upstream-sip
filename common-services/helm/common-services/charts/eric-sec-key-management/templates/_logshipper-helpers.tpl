...
*/}}
{{- define "eric-sec-key-management.logshipper-global" -}}
...
*/}}
{{- define "eric-sec-key-management.logshipper-internal" -}}
...
*/}}
{{- define "eric-sec-key-management.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-sec-key-management.logshipper-name" -}}
...
app.kubernetes.io/name: {{ include "eric-sec-key-management.name" . | quote }}
...
*/}}
{{- define "eric-sec-key-management.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-sec-key-management.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-sec-key-management.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-sec-key-management.logshipper-container" -}}
{{- $g := fromJson (include "eric-sec-key-management.logshipper-global" .) }}
{{- $default := fromJson (include "eric-sec-key-management.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-sec-key-management.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-sec-key-management.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-sec-key-management.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-sec-key-management.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-sec-key-management.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-sec-key-management.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-sec-key-management.logshipper-volume" -}}
{{- $g := fromJson (include "eric-sec-key-management.logshipper-global" .) }}
{{- $default := fromJson (include "eric-sec-key-management.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-sec-key-management.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-sec-key-management.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-sec-key-management.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-sec-key-management.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-sec-key-management.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-sec-key-management.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-sec-key-management.logshipper-annotations" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-sec-key-management.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-sec-key-management.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-sec-key-management.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
