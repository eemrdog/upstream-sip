...
*/}}
{{- define "eric-log-transformer.logshipper-global" -}}
...
*/}}
{{- define "eric-log-transformer.logshipper-internal" -}}
...
*/}}
{{- define "eric-log-transformer.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-log-transformer.logshipper-name" -}}
...
app.kubernetes.io/name: {{ include "eric-log-transformer.name" . | quote }}
...
*/}}
{{- define "eric-log-transformer.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-log-transformer.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-log-transformer.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-log-transformer.logshipper-container" -}}
{{- $g := fromJson (include "eric-log-transformer.logshipper-global" .) }}
{{- $default := fromJson (include "eric-log-transformer.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-log-transformer.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-log-transformer.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-log-transformer.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-log-transformer.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-log-transformer.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-log-transformer.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-log-transformer.logshipper-volume" -}}
{{- $g := fromJson (include "eric-log-transformer.logshipper-global" .) }}
{{- $default := fromJson (include "eric-log-transformer.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-log-transformer.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-log-transformer.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-log-transformer.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-log-transformer.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-log-transformer.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-log-transformer.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-log-transformer.logshipper-annotations" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-log-transformer.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-log-transformer.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-log-transformer.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
