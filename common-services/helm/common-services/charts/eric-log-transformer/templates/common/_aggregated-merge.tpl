...
{{- define "eric-log-transformer.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-log-transformer.mergeAnnotations" -}}
  {{- include "eric-log-transformer.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-log-transformer.mergeLabels" -}}
  {{- include "eric-log-transformer.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
