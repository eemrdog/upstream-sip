...
*/}}
{{- define "eric-data-document-database-pg.logshipper-global" -}}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-internal" -}}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-name" -}}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-labels" }}
app.kubernetes.io/name: {{ include "eric-data-document-database-pg.name" . | quote }}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-container" -}}
...
- name: "logshipper"
  ...
  - name: LOG_LEVEL
    value: {{ .Values.log.logshipper.level | quote | default "info" | upper }}
  ...
  - name: SERVICE_ID
    value: {{ include "eric-data-document-database-pg.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-data-document-database-pg.logshipper-service-fullname" . }}-logshipper-cfg"
...
{{/*
Log Shipper sidecar container for hook spec
*/}}
{{- define "eric-data-document-database-pg.logshipper-container-hook" -}}
{{- $g := fromJson (include "eric-data-document-database-pg.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-document-database-pg.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-data-document-database-pg.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-data-document-database-pg.logshipper-volume" -}}
{{- $g := fromJson (include "eric-data-document-database-pg.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-document-database-pg.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-data-document-database-pg.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}

{{/*
Log Shipper sidecar related volumes for hook
*/}}
{{- define "eric-data-document-database-pg.logshipper-volume-hook" -}}
{{- $g := fromJson (include "eric-data-document-database-pg.logshipper-global" .) }}
{{- $default := fromJson (include "eric-data-document-database-pg.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert-hook"
  secret:
    secretName: "{{ include "eric-data-document-database-pg.logshipper-service-fullname" . }}-lt-client-cert-hook"
    optional: false
{{- end }}
{{- end -}}
...
spec:
  ...
  certificate:
    subject:
      cn: {{ include "eric-data-document-database-pg.logshipper-service-fullname" . | quote }}
    issuer:
...
ClientCertificate Resource declaration file for TLS between logshipper and logtransformer
*/}}
{{- define "eric-data-document-database-pg.logshipper-tls-cert-lt-client-hook" -}}
{{- $default := fromJson (include "eric-data-document-database-pg.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-data-document-database-pg.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
apiVersion: "siptls.sec.ericsson.com/v1"
...
{{- define "eric-data-document-database-pg.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
