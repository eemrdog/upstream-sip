...
{{- define "eric-fh-snmp-alarm-provider.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-fh-snmp-alarm-provider.mergeAnnotations" -}}
  {{- include "eric-fh-snmp-alarm-provider.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-fh-snmp-alarm-provider.mergeLabels" -}}
  {{- include "eric-fh-snmp-alarm-provider.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
