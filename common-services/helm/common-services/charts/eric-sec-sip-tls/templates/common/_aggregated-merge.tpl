...
{{- define "eric-sec-sip-tls.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sec-sip-tls.mergeAnnotations" -}}
  {{- include "eric-sec-sip-tls.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sec-sip-tls.mergeLabels" -}}
  {{- include "eric-sec-sip-tls.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
