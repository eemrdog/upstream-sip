...
{{- define "eric-fh-alarm-handler.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-fh-alarm-handler.mergeAnnotations" -}}
  {{- include "eric-fh-alarm-handler.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-fh-alarm-handler.mergeLabels" -}}
  {{- include "eric-fh-alarm-handler.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}