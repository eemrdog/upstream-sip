...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-global" -}}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-internal" -}}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-service-fullname" -}}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-name" -}}
...
app.kubernetes.io/name: {{ include "eric-fh-alarm-handler.name" . | quote }}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
*/}}
{{- define "eric-fh-alarm-handler.LsSeccompProfile" -}}
{{- $default := fromJson (include "eric-fh-alarm-handler.logshipper-default-value" .) }}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-container" -}}
{{- $g := fromJson (include "eric-fh-alarm-handler.logshipper-global" .) }}
{{- $default := fromJson (include "eric-fh-alarm-handler.logshipper-default-value" .) }}
- name: "logshipper"
  imagePullPolicy: {{ or $default.imageCredentials.logshipper.registry.imagePullPolicy $g.registry.imagePullPolicy }}
  image: {{ include "eric-fh-alarm-handler.logshipper-image" . }}
  args:
  ...
  securityContext:
    ...
    capabilities:
      drop:
        - "all"
    {{ include "eric-fh-alarm-handler.LsSeccompProfile" . | indent 4 }}
  env:
  - name: TZ
  ...
  - name: SERVICE_ID
    value: {{ include "eric-fh-alarm-handler.logshipper-service-fullname" . }}
  - name: CONTAINER_NAME
    value: logshipper
  livenessProbe:
    exec:
  ...
  - name: "{{ include "eric-fh-alarm-handler.logshipper-service-fullname" . }}-logshipper-cfg"
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-storage-path" }}
{{- $default := fromJson (include "eric-fh-alarm-handler.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  mountPath: {{ $default.logshipper.storagePath | quote }}
{{- end -}}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-volume" -}}
{{- $g := fromJson (include "eric-fh-alarm-handler.logshipper-global" .) }}
{{- $default := fromJson (include "eric-fh-alarm-handler.logshipper-default-value" .) }}
- name: "eric-log-shipper-storage-path"
  emptyDir:
...
- name: "lt-client-cert"
  secret:
    secretName: "{{ include "eric-fh-alarm-handler.logshipper-service-fullname" . }}-lt-client-cert"
    optional: true
{{- end }}
{{- end -}}
...
*/}}
{{- define "eric-fh-alarm-handler.logshipper-tls-cert-lt-client" -}}
{{- $default := fromJson (include "eric-fh-alarm-handler.logshipper-default-value" .) -}}
{{- $g := fromJson (include "eric-fh-alarm-handler.logshipper-global" .) -}}
{{- if $g.security.tls.enabled -}}
...
metadata:
  name: "{{ include "eric-fh-alarm-handler.logshipper-service-fullname" . }}-lt-client-cert"
  labels:
    {{- include "eric-fh-alarm-handler.logshipper-labels" . | indent 4 }}
  annotations:
    {{- include "eric-fh-alarm-handler.annotations" . | indent 4 }}
spec:
  kubernetes:
    generatedSecretName: "{{ include "eric-fh-alarm-handler.logshipper-service-fullname" . }}-lt-client-cert"
    certificateName: "clicert.pem"
    privateKeyName: "cliprivkey.pem"
  certificate:
    subject:
      cn: {{ include "eric-fh-alarm-handler.logshipper-service-fullname" . | quote }}
    issuer:
...
{{- define "eric-fh-alarm-handler.logshipper-default-value" -}}
  {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
