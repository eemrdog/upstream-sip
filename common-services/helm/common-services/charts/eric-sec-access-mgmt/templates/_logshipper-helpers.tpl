...
*/}}
{{- define "eric-sec-access-mgmt.logshipper-image" }}
{{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") }}
...
- name: "logshipper"
  ...
  image: {{ include "eric-sec-access-mgmt.logshipper-image" . }}
  args:
...
metadata:
  ...
  annotations:
    {{- include "eric-sec-access-mgmt.logshipper-annotations" . | indent 4 }}
spec:
  kubernetes:
