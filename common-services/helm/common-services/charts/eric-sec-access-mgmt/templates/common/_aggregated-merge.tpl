...
{{- define "eric-sec-access-mgmt.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-sec-access-mgmt.mergeAnnotations" -}}
  {{- include "eric-sec-access-mgmt.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-sec-access-mgmt.mergeLabels" -}}
  {{- include "eric-sec-access-mgmt.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
