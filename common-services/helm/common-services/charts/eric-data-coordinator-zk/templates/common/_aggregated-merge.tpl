...
{{- define "eric-data-coordinator-zk.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-data-coordinator-zk.mergeAnnotations" -}}
  {{- include "eric-data-coordinator-zk.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-data-coordinator-zk.mergeLabels" -}}
  {{- include "eric-data-coordinator-zk.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
