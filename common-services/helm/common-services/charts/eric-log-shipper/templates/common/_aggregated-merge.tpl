...
{{- define "eric-log-shipper.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-log-shipper.mergeAnnotations" -}}
  {{- include "eric-log-shipper.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-log-shipper.mergeLabels" -}}
  {{- include "eric-log-shipper.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}